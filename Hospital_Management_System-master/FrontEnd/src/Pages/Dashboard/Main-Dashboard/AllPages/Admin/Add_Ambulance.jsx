...
const Add_Ambulance = () => {
  ...
  const HandleAmbuSubmit = async (e) => {
    ...
    try {
      await dispatch(AmbulanceRegister(data));
      // Refresh dashboard data after adding ambulance
      dispatch(GetAllData());
      ...
      notify("Failed to add ambulance");
    } finally {
      setloading(false);
    }
  };
        ...
        <div className="AfterSideBar">
          <div className="mainAmbupance">
            ...
            <form onSubmit={HandleAmbuSubmit}>
              ...
              <button type="submit" className="formsubmitbutton" disabled={loading}>
